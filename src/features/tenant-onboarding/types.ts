...
export const ONBOARDING_FORM_STEPS: OnboardingFormStep[] = [
  {
    ...
    icon: 'User',
    fields: ['full_name', 'date_of_birth', 'gender', 'blood_group', 'emergency_contact_name', 'emergency_contact_phone'],
  },
  {
    id: 'identity',
    ...
    icon: 'Shield',
    fields: ['id_proof_type', 'id_proof_number', 'id_proof_url', 'address_proof_url'],
  },
  {
    id: 'contact',
  ...
  },
  {
    ...
    icon: 'Home',
    fields: ['stay_purpose', 'expected_stay_duration', 'move_in_date'],
  },
  {
    id: 'payment',
