...
export const PaymentReminderTemplate = forwardRef<HTMLDivElement, PaymentReminderTemplateProps>(
  ({ data }, ref) => {
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <tbody>
              <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                ...
                <td style={{ padding: '10px 16px', fontWeight: 500, fontSize: '13px', color: '#1a1a1a' }}>{data.tenant.name}</td>
              </tr>
              <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                <td style={{ padding: '10px 16px', color: '#6b7280', fontSize: '13px' }}>For Month:</td>
                <td style={{ padding: '10px 16px', fontWeight: 500, fontSize: '13px', color: '#1a1a1a' }}>{data.stay.month}</td>
              </tr>
              <tr style={{ borderBottom: '1px solid #f3f4f6' }}>
                <td style={{ padding: '10px 16px', color: '#6b7280', fontSize: '13px' }}>Room No:</td>
                <td style={{ padding: '10px 16px', fontWeight: 500, fontSize: '13px', color: '#1a1a1a' }}>{data.stay.roomNo}</td>
              </tr>
              <tr>
                <td style={{ padding: '10px 16px', color: '#6b7280', fontSize: '13px' }}>Monthly Rent:</td>
                <td style={{ padding: '10px 16px', fontWeight: 500, fontSize: '13px', color: '#1a1a1a' }}>{formatCurrency(data.payment.amount)}</td>
              </tr>
            </tbody>
          </table>
        </div>
