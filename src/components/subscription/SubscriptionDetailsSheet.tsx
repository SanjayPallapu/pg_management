  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 bg-[#0a0b16] border-t border-slate-900/80 backdrop-blur-md flex items-center justify-between gap-4 z-20 shadow-[0_-10px_25px_rgba(0,0,0,0.5)]">
