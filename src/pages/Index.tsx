...
const Index = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className={`sticky top-0 z-40 border-b border-border/60 bg-background transition-transform duration-300 ${headerVisible ? 'translate-y-0' : '-translate-y-full'} pt-[env(safe-area-inset-top,0px)]`}>
